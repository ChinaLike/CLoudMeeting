...
final class AdapterImpl implements View.OnClickListener, View.OnLongClickListener {
     ...
     * 分割线
     */
    private GradientDrawable verticalDeviderDrawable,horizontalDeviderDrawable;
     ...
     * @param width
     */
    public void setDevider(int color, int width) {
        verticalDeviderDrawable = new GradientDrawable();
        verticalDeviderDrawable.setColor(color);
        verticalDeviderDrawable.setSize(width,-1);
        horizontalDeviderDrawable = new GradientDrawable();
        horizontalDeviderDrawable.setColor(color);
        horizontalDeviderDrawable.setSize(-1,width);
    }
