...
import com.felipecsl.CustomLinearLayoutManager;
...
public class AsymmetricRecyclerView extends RecyclerView implements AsymmetricView {
    ...
    public AsymmetricRecyclerView(Context context, AttributeSet attrs) {
        ...
        manager = new CustomLinearLayoutManager(context, LinearLayoutManager.VERTICAL, false);
    ...
    public void setScrollEnabled(boolean isScrollEnabled) {
        manager.setScrollEnabled(isScrollEnabled);
    }
